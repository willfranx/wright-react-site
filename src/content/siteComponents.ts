export const blockComponents = {
  ...
  topbar:
    "mx-auto mb-5 flex w-full max-w-[1180px] flex-col items-start gap-5 rounded-[22px] border border-[rgba(28,23,18,0.12)] bg-[#d2d3db] px-4 py-4 shadow-[rgba(15,12,8,0.1)_0_18px_40px_-20px,rgba(15,12,8,0.08)_0_8px_18px_-10px] backdrop-blur-[18px] transition-all duration-300 md:flex-row md:items-center md:justify-between md:px-[22px] md:py-[18px] dark:border-[rgba(245,242,238,0.12)] dark:bg-[rgba(30,26,23,0.8)] dark:shadow-[rgba(0,0,0,0.35)_0_18px_40px_-20px,rgba(0,0,0,0.2)_0_8px_18px_-10px]",
  brand:
  ...
  navList: "m-0 flex w-full list-none flex-wrap gap-2.5 p-0 md:w-auto",
  navItem: "flex-1 basis-[calc(50%-10px)] md:flex-initial md:basis-auto",
  navLink:
    "inline-flex w-full items-center justify-center rounded-full border border-transparent px-[14px] py-2.5 text-[#4f4a46] transition-all duration-200 hover:-translate-y-px hover:border-[rgba(28,23,18,0.12)] hover:bg-[rgba(255,255,255,0.7)] hover:text-[#171412] md:w-auto dark:text-[#c8bfb5] dark:hover:border-[rgba(245,242,238,0.12)] dark:hover:bg-[#2a1827] dark:hover:text-[#f5f2ee]",
  navLinkActive:
  ...
  connectSection:
    "mb-6 grid grid-cols-1 items-center gap-5 rounded-[28px] p-6 text-center md:justify-items-center lg:grid-cols-[minmax(0,1fr)_auto] lg:justify-items-stretch lg:text-left",
  connectCopy: "max-w-[52ch]",
  connectLinks: "flex flex-col items-center justify-center gap-[14px] lg:items-end",
  buttons:
  ...
  photoCard:
    "mb-5 overflow-hidden rounded-[28px] border border-[rgba(28,23,18,0.12)] shadow-[rgba(15,12,8,0.1)_0_18px_40px_-20px,rgba(15,12,8,0.08)_0_8px_18px_-10px] dark:border-[rgba(245,242,238,0.12)] dark:shadow-[rgba(0,0,0,0.35)_0_18px_40px_-20px,rgba(0,0,0,0.2)_0_8px_18px_-10px]",
  cardKicker:
